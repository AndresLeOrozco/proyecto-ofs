...
read_file(_{filePath: Path}, Response, TS) :-
        ...
        open('../private/transpiledCode.mjs', write, Stream),
        write(Stream, Path),
	    close(Stream),
        Response = _{accepted: true, fileContent: Path, date:  AtomTS}.

 read_file(_, Response, TS):-
        Response = _{accepted: false, fileContent: '', date:  TS}.    
